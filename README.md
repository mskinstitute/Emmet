# [Abbreviations-Syntax](#abbreviations-syntax) 
...
You can use elements’ names like `div` or `p` to _generate_ HTML tags. Emmet doesn’t have a predefined set of available tag names, you can write any word and transform it into a tag: `div` → `<div></div>`, `footer` → `<footer></footer>` and so on.
...
#### [](#changing-numbering-base-and-direction)Changing numbering base and direction
...
## [](#notes-on-abbreviation-formatting)Notes on abbreviation formatting
